% Compute ephemeris of a satellite from a TLE using SGP4 propagation model
% Adapted from Mahooti M., 2021, SGP4 (https://www.mathworks.com/matlabcentral/fileexchange/62013-sgp4), 
...
%
% OUTPUT
% AR = AR topocentrico alla data del satellite (gradi)
% DEC = Declinazione topocentrica alla data del satellite (gradi)
%
% Albino Carbognani, OAS
% Version 11 September 2020

function [AR, DEC]=SGP4_Ephemeris(temp_tle, Lat, Long, h, MJD_Ephemeris)
...
% fprintf('      ');
% fprintf('                     JD                AR              DEC                    [Deg]\n');
% fprintf('  %32.7f%16.5f%16.5f \n\n', JD_UTC, C*alfa_data_g, C*delta_data_g);
% fprintf('      ');
% fprintf('                     JD                AR t            DEC t                  [Deg]\n');
% fprintf('  %32.7f%16.5f%16.5f \n\n',JD_UTC, C*alfa_data_t, C*delta_data_t);
